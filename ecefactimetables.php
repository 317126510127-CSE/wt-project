...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="ecefac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="ecefac.php">Meetings</a></li>
      <li class="active"><a href="ecefactimetables.php">Timetables</a></li>
      <li><a href="ecefacexams.php">Exams</a></li>
      <li><a href="ecefacacademic.php">Academic</a></li>
      <li><a href="ecefacsports.php">Sports</a></li>
      <!--<li><a href="ece2.php">Student Circulars</a></li>-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='Teacher'  and  Category='timetables' order by Lastdate desc");
  ...
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp /  </td>
               <td><a href="delete12.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
