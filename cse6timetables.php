...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="cse6.php"><b>StudentCorner</b></a><li>
      <li><a href="cse6.php">Meetings</a></li>
      <li class="active"><a href="cse6timetables.php">Timetables</a></li>
      <li><a href="cse6exams.php">Exams</a></li>
      <li><a href="cse6academic.php">Academic</a></li>
      <li><a href="cse6sports.php">Sports</a></li>
...
<li>&nbsp &nbsp  </li>-->
 <li>  <a class="navbar-brand" href="csefac5.php"><h5>BACK</h5></a></li>
<li>&nbsp &nbsp  </li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Student'  and  Category='timetables' order by Lastdate desc");
