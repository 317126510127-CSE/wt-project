...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="civilhodtimetables.php">Timetables</a></li>
      <li><a href="civilhodexams.php">Exams</a></li>
      <li class="active"><a href="civilhodacademic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='HOD'  and  Category='academic' order by Lastdate desc ");
