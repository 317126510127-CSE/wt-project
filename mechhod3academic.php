...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="mechhod3timetables.php">Timetables</a></li>
      <li><a href="mechhod3exams.php">Exams</a></li>
      <li class="active"><a href="mechhod3academic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'mech'  and type='HOD'  and  Category='academic' order by Lastdate desc ");
