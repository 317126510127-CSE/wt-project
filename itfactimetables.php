...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='Teacher'  and  Category='timetables' order by Lastdate desc");
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="delete16.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
