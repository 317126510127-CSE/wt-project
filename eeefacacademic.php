...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="eeefactimetables.php">Timetables</a></li>
      <li><a href="eeefacexams.php">Exams</a></li>
      <li class="active"><a href="eeefacacademic.php">Academic</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='Teacher'  and  Category='academic' order by Lastdate desc");
