...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="studentpage.php"><b>StudentCorner</b></a><li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and ( type='Student' or     type='teacher')     and  Category='meetings'");
