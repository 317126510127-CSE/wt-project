...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="chemical4.php"><b>StudentCorner</b></a><li>
      <li><a href="chemical4.php">Meetings</a></li>
      <li class="active"><a href="chemical4timetables.php">Timetables</a></li>
      <li><a href="chemical4exams.php">Exams</a></li>
      <li><a href="chemical4academic.php">Academic</a></li>
      <li><a href="chemical4sports.php">Sports</a></li>
      
     <li>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</li>
          
          <li>  <a class="navbar-brand" href="chemicalfac3.php"><h5>BACK</h5></a></li>
<li>&nbsp &nbsp  </li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='Student'  and  Category='timetables' order by Lastdate desc ");
