...
<html lang="en">
<head>
  <tciville>student home</tciville>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, incivilial-scale=1">
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="civil6.php"><b>StudentCorner</b></a><li>
      <li><a href="civil6.php">Meetings</a></li>
      <li><a href="civil6timetables.php">Timetables</a></li>
      <li><a href="civil6exams.php">Exams</a></li>
      <li class="active"><a href="civil6academic.php">Academic</a></li>
      <li><a href="civil6sports.php">Sports</a></li>
...
<li>&nbsp &nbsp  </li>-->
 <li>  <a class="navbar-brand" href="civilfac5.php"><h5>BACK</h5></a></li>
<li>&nbsp &nbsp  </li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='Student'  and  Category='academic' order by Lastdate desc");
...
<head>
  ...
  <tciville>Download files</tciville>
</head>
<body>
