...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="csefac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="csefac.php">Meetings</a></li>
      <li class="active"><a href="csefactimetables.php">Timetables</a></li>
      <li><a href="csefacexams.php">Exams</a></li>
      <li><a href="csefacacademic.php">Academic</a></li>
      <li><a href="csefacsports.php">Sports</a></li>
   <!--   <li><a href="cse2.php">Student Circulars</a></li>-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Teacher'  and  Category='timetables' order by Lastdate desc");
  ...
  <?php foreach ($files as $file): ?>
   ...
   <!--   <td><?php // echo $file['id'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td>  -->
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp / </td>
         <td><a href="delete11.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
