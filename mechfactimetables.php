...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="mechfac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="mechfac.php">Meetings</a></li>
      <li class="active"><a href="mechfactimetables.php">Timetables</a></li>
      <li><a href="mechfacexams.php">Exams</a></li>
      <li><a href="mechfacacademic.php">Academic</a></li>
      <li><a href="mechfacsports.php">Sports</a></li>
      <!--<li><a href="mech2.php">Student Circulars</a></li>-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'mech'  and type='Teacher'  and  Category='timetables' order by Lastdate desc");
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="delete15.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
