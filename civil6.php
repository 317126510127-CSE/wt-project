...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="civil6.php">Meetings</a></li>
      <li><a href="civil6timetables.php">Timetables</a></li>
      <li><a href="civil6exams.php">Exams</a></li>
      <li><a href="civil6academic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='Student'  and  Category='meetings' order by Lastdate desc");
