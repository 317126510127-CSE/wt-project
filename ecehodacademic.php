...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="ecehod.php"><b>ECE HOD Corner</b></a><li>
      <li><a href="ecehod.php">Meetings</a></li>
      <li><a href="ecehodtimetables.php">Timetables</a></li>
      <li class="active"><a href="ecehodexams.php">Exams</a></li>
      <li><a href="ecehodacademic.php">Academic</a></li>
      <li><a href="ecehodsports.php">Sports</a></li>
     <!-- <li><a href="ece1.php">Student Circulars</a></li>
      <li><a href="ece1fac.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='HOD'  and  Category='academic' order by Lastdate desc ");
...
<tbody>
 ...
 <td><a href="uploads2/<?php echo $file['name'] ?>" target="_blank">VIEW    </a> &nbsp &nbsp &nbsp   /  </td>
  <td><a href="delete22.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>

         <!-- <td>  <a href="download.php?file_id=<?php//s echo $file['id'] ?>">Download</a> &nbsp &nbsp &nbsp   &nbsp &nbsp   &nbsp &nbsp </td>-->
