...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="chemical3.php">Meetings</a></li>
      <li><a href="chemical3timetables.php">Timetables</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='Student'  and  Category='meetings' order by Lastdate desc");
