...
<nav class="navbar navbar-default">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="csefac.php">Meetings</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Teacher'  and  Category='meetings' order by Lastdate desc");
