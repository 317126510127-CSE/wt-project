...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="cse.php"><b>StudentCorner</b></a><li>
      <li ><a href="cse.php">Meetings</a></li>
      <li><a href="csetimetables.php">Timetables</a></li>
      <li  ><a href="cseexams.php">Exams</a></li>
      <li class="active"><a href="cseacademic.php">Academic</a></li>
      <li ><a href="csesports.php">Sports</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Student'  and  Category='academic' order by Lastdate desc");
  ...
  <?php foreach ($files as $file): ?>
    ...
    <!--  <td><?php// echo $file['id'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td>  -->
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp / </td>
             <td><a href="delete.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
