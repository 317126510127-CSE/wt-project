...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="itfactimetables.php">Timetables</a></li>
      <li><a href="itfacexams.php">Exams</a></li>
      <li class="active"><a href="itfacacademic.php">Academic</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='Teacher'  and  Category='academic' order by Lastdate desc");
