...
<nav class="navbar navbar-default">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="chemicalfac.php">Meetings</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chemical'  and type='Teacher'  and  Category='meetings' order by Lastdate desc");
