...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="eeetimetables.php">Timetables</a></li>
      <li  ><a href="eeeexams.php">Exams</a></li>
      <li class="active"><a href="eeeacademic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='Student'  and  Category='academic' order by Lastdate desc");
