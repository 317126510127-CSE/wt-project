...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="ecefactimetables.php">Timetables</a></li>
      <li><a href="ecefacexams.php">Exams</a></li>
      <li class="active"><a href="ecefacacademic.php">Academic</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='Teacher'  and  Category='academic'  order by Lastdate desc");
