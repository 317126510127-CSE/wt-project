...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="itfac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="itfac.php">Meetings</a></li>
      <li class="active"><a href="itfactimetables.php">Timetables</a></li>
      <li><a href="itfacexams.php">Exams</a></li>
      <li><a href="itfacacademic.php">Academic</a></li>
      <li><a href="itfacsports.php">Sports</a></li>
     <!-- <li><a href="it2.php">Student Circulars</a></li>-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Teacher'  and  Category='academic' order by Lastdate desc");
...
<tbody>
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    /</a>  </td>
            <td><a href="example1.php" target="_blank" >DELETE   </a>  &nbsp &nbsp  &nbsp &nbsp   &nbsp &nbsp </td>
