...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="civilfac.php">Meetings</a></li>
      <li><a href="civilfactimetables.php">Timetables</a></li>
      <li><a href="civilfacexams.php">Exams</a></li>
      <li class="active"><a href="civilfacacademic.php">Academic</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='Teacher'  and  Category='academic' order by Lastdate desc");
