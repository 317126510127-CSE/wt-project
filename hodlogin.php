...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="collapse navbar-collapse" id="myNavbar">
    	    <center><h3><i><b>HOD Login</b></i></h3></center>
...
<?php
session_start();
$con=mysqli_connect("localhost","root","","hodlogin");
...
if (isset($_POST['username'])){
  ...
  //echo $dept;
  $user=$username;
        $query = "SELECT * FROM `hodlogin` WHERE username='$username'
...
elseif ($rows==1 and $dept=="eee")
{
	...
	header("Location:eeehod.php");
}
elseif ($rows==1 and $dept=="mech")
{

	header("Location:mechhod3.php");
	//echo $dept;
}
...
elseif ($rows==1 and $dept=="civil")
{
	...
	header("Location:civilhod3.php");
}
elseif ($rows==1 and $dept=="chemical")
{

	header("Location:chemicalhod3.php");
}
else if ($rows==1 and $dept=="it")
{

	header("Location:ithod3.php");
}
/*else if($rows==1 and $dept=="all")
{
header("Location:allhod.php");
//echo $dept;
}*/
else
{
