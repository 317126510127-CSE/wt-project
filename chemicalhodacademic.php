...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="chemicalhodtimetables.php">Timetables</a></li>
      <li><a href="chemicalhodexams.php">Exams</a></li>
      <li class="active"><a href="chemicalhodacademic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='HOD'  and  Category='academic' order by Lastdate desc ");
