...
elseif ($rows==1 and $dept=="eee")
{
    ...
    header("Location:eee3.php");
}
elseif ($rows==1 and $dept=="mech")
{

    header("Location:mech3.php");
    //echo $dept;
}
...
elseif ($rows==1 and $dept=="civil")
{
    ...
    header("Location:civil3.php");
}
elseif ($rows==1 and $dept=="chemical")
{

    header("Location:chemical3.php");
}
else if ($rows==1 and $dept=="it")
{

    header("Location:it3.php");
}
...
header("Location:studentlogin1.php");
        ...
        echo "Invalid login <br> Enter correct credentials";
'alert("Invalid username and password");'; 
       // header("Location: studentlogin1.php");
echo 'window.location.href = "loginexample.php";';
echo '</script>'; 
