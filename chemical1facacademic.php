...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="chemical1facacademic.php">Academic</a></li>
            <li><a href="chemical1facsports.php">Sports</a></li>
                  <li><a href="chemical1.php">CHEMICAL Faculty Circulars</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='Teacher'  and  Category='academic' order by Lastdate desc ");
