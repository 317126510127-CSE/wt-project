...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="all.php"><b>StudentCorner</b></a><li>
      <li ><a href="all.php">Meetings</a></li>
      <li class="active"><a href="alltimetables.php">Timetables</a></li>
      <li  ><a href="allexams.php">Exams</a></li>
      <li ><a href="allacademic.php">Academic</a></li>
      <li ><a href="allsports.php">Sports</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'all'  and type='Student'  and  Category='timetables' order by Lastdate desc");
