...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li ><a href="ittimetables.php">Timetables</a></li>
      <li  ><a href="itexams.php">Exams</a></li>
      <li class="active"><a href="itacademic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='Student'  and  Category='academic' order by Lastdate desc");
