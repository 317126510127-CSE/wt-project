...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="civil.php"><b>StudentCorner</b></a><li>
      <li class="active"><a href="civil.php">Meetings</a></li>
      <li ><a href="civiltimetables.php">Timetables</a></li>
      <li  ><a href="civilexams.php">Exams</a></li>
      <li ><a href="civilacademic.php">Academic</a></li>
      <li ><a href="civilsports.php">Sports</a></li>
  ...
  <?php foreach ($files as $file): ?>
    <tr>
     <!-- <td><?php // echo $file['id'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td>  -->
      ...
      <td><a href="delete6.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
