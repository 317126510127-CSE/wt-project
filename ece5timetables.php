...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="ece5.php"><b>StudentCorner</b></a><li>
      <li><a href="ece5.php">Meetings</a></li>
      <li class="active"><a href="ece5timetables.php">Timetables</a></li>
      <li><a href="ece5exams.php">Exams</a></li>
      <li><a href="ece5academic.php">Academic</a></li>
      <li><a href="ece5sports.php">Sports</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='Student'  and  Category='timetables' order by Lastdate desc");
