...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="csehod.php">Meetings</a></li>
      <li><a href="csehodtimetables.php">Timetables</a></li>
      <li><a href="csehodexams.php">Exams</a></li>
      <li><a href="csehodacademic.php">Academic</a></li>
      <li><a href="csehodsports.php">Sports</a></li>
     <!-- <li><a href="cse3.php">Student Circulars</a></li>
      <li><a href="cse1fac.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='HOD'  and  Category='meetings' order by Lastdate desc ");
