...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="eeehod.php"><b>EEE HOD Corner</b></a><li>
      <li><a href="eeehod.php">Meetings</a></li>
      <li class="active"><a href="eeehodtimetables.php">Timetables</a></li>
      <li><a href="eeehodexams.php">Exams</a></li>
      <li><a href="eeehodacademic.php">Academic</a></li>
      <li><a href="eeehodsports.php">Sports</a></li>
      <!--<li><a href="eee1.php">Student Circulars</a></li>
      <li><a href="eee1fac.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
...
<tbody>
 ...
 <td><a href="delete23.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
