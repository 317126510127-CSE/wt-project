...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="ece6timetables.php">Timetables</a></li>
      <li><a href="ece6exams.php">Exams</a></li>
      <li class="active"><a href="ece6academic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='Student'  and  Category='academic' order by Lastdate desc");
