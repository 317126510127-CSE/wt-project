...
<nav class="navbar navbar-default">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="ecefac5.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li><a href="ecefac5.php">Meetings</a></li>
      <li class="active"><a href="ecefac5timetables.php">Timetables</a></li>
      <li><a href="ecefac5exams.php">Exams</a></li>
      <li><a href="ecefac5academic.php">Academic</a></li>
      <li><a href="ecefac5sports.php">Sports</a></li>
      <li><a href="ece6.php">Student Circulars</a></li>
...
<li>&nbsp &nbsp  </li>
 ...
 <li>  <a class="navbar-brand" href="ecehod3.php"><h5>BACK</h5></a></li>
<li>&nbsp &nbsp  </li>
-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='Teacher'  and  Category='timetables' order by Lastdate desc");
