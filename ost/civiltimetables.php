...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="civil.php">StudentCorner</a>
    </div>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='Student'  and  Category='timetables'");
