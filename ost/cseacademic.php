...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='Student'  and  Category='academic'");
  ...
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><?php echo floor($file['size'] / 1000) . ' KB'; ?>   &nbsp &nbsp   &nbsp &nbsp</td> 
            <td><a href="download.php?file_id=<?php echo $file['id'] ?>">Download</a>   &nbsp &nbsp   &nbsp &nbsp </td>
      <td><?php echo $file['Lastdate'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td> 
