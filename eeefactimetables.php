...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="eeefac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li ><a href="eeefac.php">Meetings</a></li>
      <li class="active"><a href="eeefactimetables.php">Timetables</a></li>
      <li><a href="eeefacexams.php">Exams</a></li>
      <li><a href="eeefacacademic.php">Academic</a></li>
      <li><a href="eeefacsports.php">Sports</a></li>
      <!--<li><a href="eee2.php">Student Circulars</a></li>-->
  ...
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp /  </td>
       <td><a href="delete13.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
