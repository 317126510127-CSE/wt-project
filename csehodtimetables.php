...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="csehod.php"><b>CSE HOD Corner</b></a><li>
      <li><a href="csehod.php">Meetings</a></li>
      <li class="active"><a href="csehodtimetables.php">Timetables</a></li>
      <li><a href="csehodexams.php">Exams</a></li>
      <li><a href="csehodacademic.php">Academic</a></li>
      <li><a href="csehodsports.php">Sports</a></li>
   <!--   <li><a href="cse1.php">Student Circulars</a></li>
      <li><a href="csefac1.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'cse'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
...
<tbody>
 ...
 <td><a href="uploads2/<?php echo $file['name'] ?>" target="_blank">VIEW    </a> &nbsp &nbsp &nbsp  /  </td>
  <td><a href="delete21.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
