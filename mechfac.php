...
<nav class="navbar navbar-default">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="mechfac.php">Meetings</a></li>
      <li><a href="mechfactimetables.php">Timetables</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'mech'  and type='Teacher'  and  Category='meetings' order by Lastdate desc");
