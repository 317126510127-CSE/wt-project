...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="mechhod3.php"><b>CSE HOD Corner</b></a><li>
      <li><a href="mechhod3.php">Meetings</a></li>
      <li class="active"><a href="mechhod3timetables.php">Timetables</a></li>
      <li><a href="mechhod3exams.php">Exams</a></li>
      <li><a href="mechhod3academic.php">Academic</a></li>
      <li><a href="mechhod3sports.php">Sports</a></li>
      <li><a href="mech3.php">Student Circulars</a></li>
      <li><a href="mechfac3.php">Faculty Circulars</a></li>
      <li>&nbsp &nbsp  </li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'mech'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
