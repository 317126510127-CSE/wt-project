...
<nav class="navbar navbar-default">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="civilfac.php">FACULTY CORNER</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="civilfac.php">Meetings</a></li>
      <li><a href="civilfactimetables.php">Timetables</a></li>
      <li><a href="civilfacexams.php">Exams</a></li>
      <li><a href="civilfacacademic.php">Academic</a></li>
      <li><a href="civilfacsports.php">Sports</a></li>
      <!--<li><a href="civil2.php">Student Circulars</a></li>-->
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='Teacher'  and  Category='meetings' order by Lastdate desc");
  ...
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp / </td>
           <td><a href="delete17.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
