...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="ithod.php"><b>IT HOD Corner</b></a><li>
      <li><a href="ithod.php">Meetings</a></li>
      <li class="active"><a href="ithodtimetables.php">Timetables</a></li>
      <li><a href="ithodexams.php">Exams</a></li>
      <li><a href="ithodacademic.php">Academic</a></li>
      <li><a href="ithodsports.php">Sports</a></li>
     <!-- <li><a href="it1.php">Student Circulars</a></li>
      <li><a href="it1fac.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
...
<tbody>
 ...
 <td><a href="delete26.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
