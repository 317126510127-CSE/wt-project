...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="itfacexams.php">Exams</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='Teacher'  and  Category='exams' order by Lastdate desc");
