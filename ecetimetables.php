...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="ece.php"><b>StudentCorner</b></a><li>
      <li ><a href="ece.php">Meetings</a></li>
      <li class="active"><a href="ecetimetables.php">Timetables</a></li>
      <li ><a href="eceexams.php">Exams</a></li>
      <li ><a href="eceacademic.php">Academic</a></li>
      <li ><a href="ecesports.php">Sports</a></li>
    ...
    <tr>
     <!-- <td><?php //echo $file['id'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td>  -->
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp /  </td>
           <td><a href="delete1.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
