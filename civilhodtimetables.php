...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="civilhod.php"><b>CIVIL HOD Corner</b></a><li>
      <li><a href="civilhod.php">Meetings</a></li>
      <li class="active"><a href="civilhodtimetables.php">Timetables</a></li>
      <li><a href="civilhodexams.php">Exams</a></li>
      <li><a href="civilhodacademic.php">Academic</a></li>
      <li><a href="civilhodsports.php">Sports</a></li>
     <!-- <li><a href="civil1.php">Student Circulars</a></li>
      <li><a href="civil1fac.php">Faculty Circulars</a></li>-->
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'civil'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
...
<tbody>
 ...
 <td><a href="uploads2/<?php echo $file['name'] ?>" target="_blank">VIEW    </a> &nbsp &nbsp &nbsp  / </td>
  <td><a href="delete27.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
