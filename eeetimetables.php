...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="eee.php"><b>StudentCorner</b></a><li>
      <li ><a href="eee.php">Meetings</a></li>
      <li class="active"><a href="eeetimetables.php">Timetables</a></li>
      <li  ><a href="eeeexams.php">Exams</a></li>
      <li ><a href="eeeacademic.php">Academic</a></li>
      <li ><a href="eeesports.php">Sports</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='Student'  and  Category='timetables' order by Lastdate desc");
    ...
    <tr>
     <!-- <td><?php //echo $file['id'];  ?>   &nbsp &nbsp   &nbsp &nbsp</td> --> 
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp /  </td>
       <td><a href="delete2.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
