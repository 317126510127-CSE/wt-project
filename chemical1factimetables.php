...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="chemical1fac.php"><b>CHEMICAL Faculty Corner</b></a><li>
      <li><a href="chemical1fac.php">Meetings</a></li>
      <li class="active"><a href="chemical1factimetables.php">Timetables</a></li>
      <li><a href="chemical1facexams.php">Exams</a></li>
      <li><a href="chemical1facacademic.php">Academic</a></li>
            <li><a href="chemical1facsports.php">Sports</a></li>
                  <li><a href="chemical1.php">CHEMICAL Student Circulars</a></li>
     <li>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</li>
          
          <li>  <a class="navbar-brand" href="chemicalhod.php"><h5>BACK</h5></a></li>
<li>&nbsp &nbsp  </li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='Teacher'  and  Category='timetables' order by Lastdate desc ");
