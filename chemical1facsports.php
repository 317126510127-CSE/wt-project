  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="chemical1facacademic.php">Academic</a></li>
            <li class="active"><a href="chemical1facsports.php">Sports</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chem'  and type='Teacher'  and  Category='sports' order by Lastdate desc ");
