...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="ecefac.php">StudentCorner</a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="ecefacsports.php">Sports</a></li>
            <li><a href="ecefacstudents.php">Student Circulars</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='Teacher'  and  Category='sports'");
