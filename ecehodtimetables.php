...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="ecehodtimetables.php">Timetables</a></li>
      <li><a href="ecehodexams.php">Exams</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'ece'  and type='HOD'  and  Category='timetables' order by Lastdate desc ");
