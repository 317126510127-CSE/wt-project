...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li><a class="navbar-brand" href="chemical.php"><b>StudentCorner</b></a><li>
      <li ><a href="chemical.php">Meetings</a></li>
      <li class="active"><a href="chemicaltimetables.php">Timetables</a></li>
      <li  ><a href="chemicalexams.php">Exams</a></li>
      <li ><a href="chemicalacademic.php">Academic</a></li>
      <li ><a href="chemicalsports.php">Sports</a></li>
...
<li>&nbsp &nbsp  </li>
 ...
 <center>
<div class="container">
  <h3>CHEMICAL STUDENTS CIRCULARS</h3>
  <p></p>
</div>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chemical'  and type='Student'  and  Category='timetables' order by Lastdate desc");
  ...
  <?php foreach ($files as $file): ?>
    <tr>
      ...
      <td><a href="uploads2/<?php echo $file['name']?>" target="_blank">VIEW    </a>&nbsp &nbsp &nbsp /  </td>
                   <td><a href="delete3.php ?file_id=<?php echo $file['id'] ?>" target="_blank">DELETE  </a>&nbsp    &nbsp &nbsp   &nbsp &nbsp    &nbsp &nbsp   &nbsp &nbsp</td>
