...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="chemicalfactimetables.php">Timetables</a></li>
      <li><a href="chemicalfacexams.php">Exams</a></li>
      <li class="active"><a href="chemicalfacacademic.php">Academic</a></li>
...
include "config.php";
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'chemical'  and type='Teacher'  and  Category='academic' order by Lastdate desc");
