...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="eeehodtimetables.php">Timetables</a></li>
      <li><a href="eeehodexams.php">Exams</a></li>
      <li class="active"><a href="eeehodacademic.php">Academic</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'eee'  and type='HOD'  and  Category='academic' order by Lastdate desc ");
