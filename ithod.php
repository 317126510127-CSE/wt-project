...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="ithod.php">Meetings</a></li>
      <li><a href="ithodtimetables.php">Timetables</a></li>
...
include "config.php";
//session_start();
$sql = mysqli_query($con,"SELECT * FROM filestable where Department= 'it'  and type='HOD'  and  Category='meetings' order by Lastdate desc ");
